    ...
    <div className='flex flex-col max-w-[1920px] mx-auto xl:px-[365px] md:px-10 sm:px-2 px-4 min-h-full'>
      ...
      <div className="flex flex-row items-center justify-between gap-3 md:gap-0 mt-[88px]">
        ...
        <div className='flex flex-col w-[520px] h-[370px] gap-[20px] flex-shrink-0'>
          ...
          <button className='font-extrabold font-["Lato"] text-base rounded-[10px] text-white p-3 m-auto tracking-wider hover:bg-[#F19090] bg-[#ED6C6C] transition duration-300'>Узнать больше!</button>
        </div>
      </div>
      ...
      <div className='flex flex-col mt-[36px]'>
        ...
        <div className='flex flex-row m-auto mt-[38px] gap-[100px]'>
