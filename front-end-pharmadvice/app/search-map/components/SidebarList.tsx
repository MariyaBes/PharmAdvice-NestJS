...
const SidebarList: FC = () => {
	const [medicationData, setMedicationData] = useState<IMedication[]>([
		{
			medication_id_: 1,
	...
	const sortPriceDown = () => {
		const sortedData = [...medicationData].sort((a,b) => a.price - b.price)
		setMedicationData(sortedData)
	}

	const sortPriceUp = () => {
		const sortedData = [...medicationData].sort((a,b) => b.price - a.price)
		setMedicationData(sortedData)
	}
	...
	const valueSearch = () => {
		const filterData = medicationData.filter(medication => medication.name.toLowerCase().includes(searchQuery.toLowerCase()))

		setMedicationData(filterData)
	}
			...
			<div className='sidebar-left-conteiner-search'>
				...
				<div className='sidebar-left-conteiner-search__search'>
					<div className='sidebar-left-conteiner-search__search-field'>
						...
						<button
							className='sidebar-left-conteiner-search__search-field--button'
							onClick={valueSearch}
						>
							Поиск
						</button>
				...
				<div className='sidebar-left-conteiner-search__filter'>
					<div className='sidebar-left-conteiner-search__filter-star' onClick={sortPriceDown}>
						<Image
					...
					<div className='sidebar-left-conteiner-search__filter-star' onClick={sortPriceUp}>
						<Image
							className='sidebar-left-conteiner-search__filter-star--icon'
							src='/images/arrangevertical.svg'
							width={'12'}
